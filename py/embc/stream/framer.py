...
from ctypes import cdll, Structure, POINTER, pointer, cast, CFUNCTYPE, \
    c_int64, c_uint32, c_uint16, c_uint8, c_void_p, c_size_t, c_char_p, \
    c_int32
...
TIMER_DONE_FN = CFUNCTYPE(None, c_void_p, c_int32)
HAL_TIME_GET_FN = CFUNCTYPE(c_int64, c_void_p)
HAL_TIMER_SET_FN = CFUNCTYPE(c_int32, c_void_p, c_int64, TIMER_DONE_FN, c_void_p, POINTER(c_uint32))
...
class Framer:
    ...
    def __init__(self):
        ...
        self.__hal_time_get = HAL_TIME_GET_FN(self._hal_time_get)
        ...
        self._hal.time_get_fn = self.__hal_time_get
        ...
        self._timer_cbk_reset()

    def _timer_cbk_reset(self):
        self.timeout = None
    ...
    def _hal_time_get(self, user_data):
        return int(self.current_time * 2 ** 30)

    def _hal_timer_set(self, user_data, timeout, cbk_fn, cbk_user_data, timer_id):
    ...
    def _hal_timer_cancel(self, user_data, timer_id):
        if timer_id != TIMER_ID:
            log.warning('incorrect timer_id %d', timer_id)
        self._timer_cbk_reset()
        return 0
